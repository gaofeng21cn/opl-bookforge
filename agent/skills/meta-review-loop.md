...
- Run at most three meta-review rounds by default. A round counts only when an independent review report exists from its own OPL-managed `producer` StageAttempt against the current declared manuscript dependencies.
