# OPL BookForge Domain Specialization
...
Machine boundary: human-readable domain specialization. Machine-readable adoption is in `contracts/standard-agent-principles-adoption.json`; BookForge contracts, source, receipts, and verification outputs remain authoritative for BookForge behavior.
...
- Generated interfaces and Agent Lab evidence are readback and handoff surfaces. They cannot claim book delivery ready, publication ready, domain ready, or production ready without the required BookForge owner evidence.

This specialization keeps book creation AI-first while preventing OPL intake, scaffold validation, or generated descriptors from becoming book authority.
