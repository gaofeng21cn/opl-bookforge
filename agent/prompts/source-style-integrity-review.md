...
- refreshes only review dimensions affected by semantic changes and clearly separates pass, quality debt, route-back, and authority blockers.
...
Major repairs require fresh review of every semantically affected dimension and its declared dependents before an integrity handoff can be reused. Content changes fail closed across content, editorial, and reference review and all downstream proof dimensions; layout- or export-only regeneration does not invalidate content, editorial, or reference review. A consumable manuscript may advance with explicit non-central quality debt, but publication/export/readiness claims remain closed while central evidence or systemic integrity gaps remain.
