...
The current helper landing implements the machine-baseline part of that rule for the bundled BookForge profile. It does not replace book-specific human visual review, pre-ship proof review, or owner/export acceptance.
