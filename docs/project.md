...
State: `active_truth`
Machine boundary: Human-readable project overview. Machine truth belongs in contracts, agent pack files, OPL validator output, OMA Agent Lab evidence, pilot evidence, runtime receipts, owner receipts, and typed blockers.
